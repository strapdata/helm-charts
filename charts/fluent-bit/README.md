# Fluent-Bit Chart for Elassandra
...
* Load Elasticsearch template and pipeline for Elassandra
...
```bash
$ helm install --name my-release strapdata/fluent-bit
```
...
```bash
$ helm install --name my-release strapdata/fluent-bit --set on_minikube=true
```
